...
- \- Die Messinstrumente sollten in einem *eigenen Abschnitt namens "Messinstrumente"* o.Ä. berichtet werden. 
...
- \- Tabellen sollten nicht als Screenshot (z. B. aus Excel) abgebildet werden. Mit einem Aufwand im einstelligen Minutenbereich kann ein deutlich schöneres Ergebnis erzielt werden. Kurz gesagt: Screenshots sehen grässlich aus; verwenden Sie sie nicht.
...
- \+- Insgesamt ist der Umfang er Datenanalyse als von mittlerer  (befriedigender) bis hoher Güte einzuschätzen. 
...
- \- Es ist *nicht korrekt, bei nicht-signifikanten Ergebnissen die Alternativhypothese abzulehnen*. Besser ist es zu sagen, dass die Nullhypothese nicht verworfen werden konnte. Allerdings sind diese Feinheiten nicht umdiskutiert in Fachkreisen, so dass dieser Punkt nicht in die Bewertung einfließt.
...
### Titel -- Inhalt Kommentare {#titelinhalt}
...
- \- "*Beweisen*" ("belegen") ist ein großes Wort; häufig hält das Forschungsdesign der vorliegenden Studie diesem starken, kausalanalytischen Begriff nicht stand. Sie sollten solche Ausdrücke mit mehr Vorsicht verwenden, da der Stand der Forschung der Stärke dieser Behauptung häufig nicht standhält. Weiterhin sollte man, wenn man diesen Ausdruck doch verwendet, ausreichend Belege für so eine weitgehende Behauptung präsentieren und etwaige Gegenargumente entkräften.
