...
date: "Letzte Aktualisierung: 2023-07-06 09:43:18" 
numbersections: TRUE 
lang: de-De
output:
  html_document:
...
- NEG Kapitel und Unterkapitel (Abschnitte) sollte *nummeriert* werden, da das die Orientierung im Text erleichtert.
...
#### Literaturverzeichnis -- Kommentare zu Aufbaufehlern {#litverzaufbau}
...
- NEG Das *Design* der Studie wurde nicht oder *nicht* ausführlich oder nicht korrekt oder nicht an der richtigen Stelle im Bericht *erläutert* (z. B. ob es um ein querschnittliches Experiment handelt mit einer UV oder um eine Beobachtungsstudie).
...
- Ein *Advance Organizer* kann sinnvoll sein, birgt aber zwei Gefahren: Zum einen wird knapper, daher wertvoller Platz, vergeben; zum anderen ist die Information häufig redundant zum Inhaltsverzeichnis. 
...
## Einführung/Einleitung (xxeinl) {#einleitung}
...
### Theorieteil - Kausalmodell (xxkausal, xxcausal)
...
Der Gutachter beziffert seine Anforderung (Für eine "gute" Leistung) an die zitierte *Quellenzahl* bei 
...
- *quant. Seminararbeiten* wie folgt: 15-20 Quellen im Bachelor (davon 25% Fachartikel) und 25-30 Quellen im Master (davon 50% Fachartikel).
