...
9. WICHTIG [Literaturverzeichnis im Aufbau ok?](#litverzaufbau)  [Im Zitieren ok](#litverzzit) [Insgesamt ok?](#litverzzitieren)
...
# CHECKLISTE -- POSTER (xxcheckposter)
...
- \- Die Seiten sind *nicht zweiseitig, sondern einseitig* gestaltet, was dem Lesefluss abträglich ist, zumindest in gedruckter Form. Zweiseitig formatierte (längere) Texte sind (den einseitig formatierten) typografisch überlegen.
...
- \- *Typische Fehler in Literaturverzeichnissen* beinhalten das Auslassen der Seitenzahl, falsche Groß- und Kleinschreibung, falsche Darstellung von Kapiteln in Herausgeberwerken oder falsche Formatierung des Verlagnamens.
...
- \-  Laut APA/DGPs (6. Auflage) ist im Literaturverzeichnis bei der Zitation eines Buches nur *ein Ort* (der zuerst genannte im Quellmaterial) anzugeben, nicht mehrere, also z. B. "Heidelberg: Springer". In der. 7. Auflage des APA-Handbuchs ist der Verlagsort wegzulassen.
...
## Qualitative Inhaltsanalyse {#quali} (xxqualinh)
...
- \- B*ehauptungen (Aussagen) sind grundsätzlich mit einer Quelle* zu belegen. Die vorliegende Arbeit hält dies nicht durchgängig ein.
...
[s. auch Abschnitt "Arugumenation"](#argumente)
...
# VORTRAGEN/PRÄSENTIEREN (xxpräs)---------------------------------------- {#präs}
